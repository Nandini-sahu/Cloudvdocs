...
const gitlabImg = 'assets/images/elements/gitlab.svg';
const dockerImg = 'assets/images/elements/docker.svg';
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            key: 'about-services-cloud-hosting',
  ...
  company: [
    {
      icon: 'bi-boxes',
      title: 'About us',
      description: 'Learn about Cloud V’s mission, vision and roadmap.',
    },
    {
      icon: 'bi-rocket',
      title: 'Career',
      badge: '3 Jobs',
      description: "Join our team and help build the future of cloud technology.",
    },
    {
      icon: 'bi-emoji-sunglasses',
      title: 'Customer stories',
      description:
        'See how teams use Cloud V to scale and succeed.',
    },
  ],
  integration: [
    {
